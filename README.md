# genpark-iterative-multi-step-web-research-synthesizer-skill
...
> **GenPark AI Agent Skill** -- Iterative multi-step web research synthesizer & deep citation co-pilot (Perplexity style)
